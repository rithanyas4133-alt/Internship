    ...
    >
      <div className="container">
        <div className="section-title-wrapper" style={{ marginBottom: 40, textAlign: 'center' }}>
          <span className="section-subtitle" style={{ color: '#38BDF8', fontSize: '12px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1.5px', display: 'block', marginBottom: '8px' }}>Target Verticals</span>
          <h2 className="section-title" style={{ fontSize: '32px', fontWeight: '800', fontFamily: 'var(--font-headings)', margin: 0 }}>Industries Served</h2>
        ...
        <div className="industry-carousel-canvas" style={{ padding: '40px 0' }}>
          <div className="carousel-platform">
            <div className="platform-rings" style={{ boxShadow: '0 0 0 2px rgba(56, 189, 248, 0.12) inset', background: 'radial-gradient(circle, rgba(56, 189, 248, 0.04) 0%, transparent 40%)' }} aria-hidden />
            <div className="platform-pulse" style={{ background: 'radial-gradient(circle, rgba(56, 189, 248, 0.08) 0%, rgba(10,20,36,0) 60%)' }} aria-hidden />
          </div>
                ...
                return (
                  <motion.div 
                    ...
                    style={{ 
                      ...
                      backgroundColor: '#0B0F19',
                      background: 'none',
                      border: isActive ? '1.5px solid #38BDF8' : '1px solid rgba(56, 189, 248, 0.25)',
                  ...
                  >
                    <div className="industry-card-inner" style={{ padding: '24px' }}>
                      <div className="industry-icon" style={{ borderColor: 'rgba(56, 189, 248, 0.25)', backgroundColor: 'rgba(56, 189, 248, 0.08)', color: '#38BDF8' }}>{it.icon}</div>
                      <div className="industry-body">
                        <div className="industry-name" style={{ fontSize: '22px', fontWeight: '700' }}>{it.name}</div>
