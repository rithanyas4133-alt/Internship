  ...
  return (
    ...
    >
      <style dangerouslySetInnerHTML={{ __html: `
        .bg-soft-blue .contact-form-card {
          background-color: rgba(255, 255, 255, 0.75);
          border-color: rgba(15, 23, 42, 0.08);
          box-shadow: 0 12px 40px rgba(15, 23, 42, 0.08);
          color: #0F172A;
        }
        .bg-soft-blue .contact-form-card h3 {
          color: #0F172A !important;
        }
        .bg-soft-blue .contact-form-card .form-label {
          color: #0F172A;
        }
        .bg-soft-blue .contact-form-card .form-control {
          background-color: rgba(15, 23, 42, 0.03);
          border-color: rgba(15, 23, 42, 0.08);
          color: #0F172A;
        }
        .bg-soft-blue .contact-form-card .form-control:focus {
          border-color: var(--accent);
          background-color: rgba(255, 255, 255, 0.95);
        }
        .bg-soft-blue .contact-form-card .form-control::placeholder {
          color: #64748b;
        }
      `}} />
      {/* --- HERO SECTION --- */}
      <section className="inner-hero contact-hero bg-dark-royal" style={{ borderBottom: '1px solid rgba(200, 162, 118, 0.18)' }}>
      ...
      <section className="section bg-soft-blue contact-section-texture">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px' }}>
                <div className="glass-card" style={{ padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                  ...
                  <h4 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '4px' }}>Call Us</h4>
                  <a href="tel:+919980138172" style={{ fontSize: '14px' }}>+91 9980138172</a>
                </div>

                <div className="glass-card" style={{ padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                  <div className="card-icon" style={{ width: '40px', height: '40px', marginBottom: '16px', color: 'var(--accent)' }}><Mail size={20} /></div>
                  <h4 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '4px' }}>Email Us</h4>
                  <a href="mailto:manohar.md@ceainfotech.com" style={{ fontSize: '14px', wordBreak: 'break-all' }}>manohar.md@ceainfotech.com</a>
                </div>
                ...
                <div className="glass-card" style={{ padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gridColumn: 'span 2' }}>
                  ...
                  <h4 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '4px' }}>Office Address</h4>
                ...
                <div className="glass-card" style={{ padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                  ...
                  <h4 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '4px' }}>Business Hours</h4>
                  <span style={{ fontSize: '13px' }}>Mon - Fri: 9:00 AM - 6:00 PM (IST)</span>
                </div>

                <div className="glass-card" style={{ padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                  <div className="card-icon" style={{ width: '40px', height: '40px', marginBottom: '16px', color: 'var(--accent)' }}><Building size={20} /></div>
                  <h4 style={{ fontSize: '14px', fontWeight: '700', marginBottom: '4px' }}>Corporate Registry</h4>
                  <span style={{ fontSize: '13px' }}>Established June 2015</span>
                </div>
              </div>
            ...
            <div className="contact-form-card">
              {submitted ? (
                ...
                >
                  ...
                  <h3 style={{ fontSize: '24px', marginBottom: '8px' }}>Message Sent Successfully</h3>
